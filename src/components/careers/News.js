    ...
    <>
      <div className="hidden md:grid grid-cols-3 gap-x-11 gap-y-14 w-full max-w-[1440px] mx-auto px-12 lg:px-[100px] py-12">
        <div className="flex flex-col h-full text-dark-gray">
          ...
          <Image className="block mt-auto mx-auto" image={firstNewsImage} />
        </div>
        <div className="flex flex-col h-full text-dark-gray">
          ...
          <Image className="block mt-auto mx-auto" image={secondNewsImage} />
        </div>
        <div className="flex flex-col h-full text-dark-gray">
          ...
          <Image className="block mt-auto mx-auto" image={thirdNewsImage} />
        </div>
      </div>
      <div className="md:hidden mt-5">
        <Slider>
          <div className="!grid gap-y-7 h-full text-dark-gray">
            ...
            <Image className="self-end mt-auto mx-auto" image={firstNewsImage} />
          </div>
          <div className="!grid gap-y-7 h-full text-dark-gray">
            ...
            <Image className="self-end mt-auto mx-auto" image={secondNewsImage} />
          </div>
          <div className="!grid gap-y-7 h-full text-dark-gray">
            ...
            <Image className="self-end mt-auto mx-auto" image={thirdNewsImage} />
          </div>
        </Slider>
      </div>
    </>
