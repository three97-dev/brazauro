  ...
  return (
    <div className="w-full lg:bg-pink">
      <div className="grid lg:grid-cols-[11fr_14fr] w-full max-w-[1440px] mx-auto">
        <div className="pt-12 pb-12 lg:pb-24 px-7 sm:px-12 lg:pr-14 lg:pl-[100px] lg:bg-pink">
          <h2>&lt;{aboutTitle}&gt;</h2>
        ...
        <div className="pt-12 pb-16 px-7 sm:px-12 lg:pr-14 lg:pl-[100px] lg:bg-pink">
          <h2>{historyTitle}</h2>
          <div className="relative md:grid grid-cols-[1fr_9fr] lg:grid grid-cols-[1fr_4fr] gap-x-4 md:gap-x-11 items-center mt-10 text-[18px] leading-[22px] font-bitter">
